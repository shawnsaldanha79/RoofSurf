...
export default function CreateListing() {
    ...
    const handleImageSubmit = async (evt) => {
        if (files.length > 0 && files.length + formData.imageUrls.length < 7) {
            ...
            try {
                const urls = await storage.uploadMultipleImages(
                    files,
                    "listings"
                );
                setFormData({
                ...
                <div className="bg-white rounded-xl shadow-md overflow-hidden p-6 md:p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-gray-600">
                            List your property on RoofSurf and reach thousands
                            of potential tenants or buyers
                        </p>
                    </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        ...
                                        disabled={uploading}
                                        className="px-4 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:opacity-70 transition-colors whitespace-nowrap"
                                    >
